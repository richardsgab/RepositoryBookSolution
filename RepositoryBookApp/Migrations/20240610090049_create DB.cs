...
namespace RepositoryBookApp.Migrations
{
    ...
    public partial class createDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Genres",
                columns: new[] { "GenreId", "BookId", "Name" },
                values: new object[,]
                {
                    { 1, null, "Genre 1" },
                    { 2, null, "Genre 2" }
            ...
            migrationBuilder.InsertData(
                table: "Books",
                columns: new[] { "BookId", "AuthorId", "BindingType", "ImagePath", "IsAvailable", "IsBestSeller", "IsNewRelease", "Title" },
                values: new object[,]
                {
                    { 1, 1, 0, "", true, false, true, "Book 1" },
                    { 2, 2, 1, "", false, true, false, "Book 2" }
                });
